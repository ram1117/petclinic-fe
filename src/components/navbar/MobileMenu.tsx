...
const MobileMenu = () => {
  ...
  return (
    <div className="lg:hidden relative z-[999]">
      ...
      {openmenu && (
        <>
          <div className="absolute top-6 right-1 h-0 w-0 border-x-[12px] border-x-transparent border-b-[16px] border-blue-100" />
          <div className="absolute w-max min-h-max top-10 right-0 bg-blue-100 p-8 rounded-md">
